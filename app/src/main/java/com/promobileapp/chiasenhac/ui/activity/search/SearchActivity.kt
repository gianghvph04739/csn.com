...
class SearchActivity : BaseActivity(), SearchListener, iLoadMore {
    ...
    override fun init() {
        ...
        songAdapter = SongAdapter(this, rvSearch, layoutManager, object : SongAdapter.OnSongClickListener {
            override fun onSongSelected(position: Int, song: Song) {
                var intent = Intent(this@SearchActivity, PlayerActivity::class.java)
